...
$botToken = "7184899056:AAFBJdPhmxc2P3AYE4qXsT1TE_7Pb3lmbpo";
...
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@PHROZEHN</code>';
$botu = "𝘽𝙊𝙏 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 ↯ @PHROZEHN";
$bota = "<b>|×| 𝘿𝙀𝙑 ↯ @PHROZEHN</b>";$eror = "<b>Error ❌</b>";
...
if ($cdata2 == "back2") {
    ...
    $videoUrl = "https://th.bing.com/th/id/OIG2.BGH.0W1FHouu8QBJb7Dc?pid=ImgGn";
...
⚠️ 𝘛𝘏𝘐𝘚 𝘛𝘖𝘗-𝘜𝘗s 𝘈𝘙𝘌 𝘕𝘖𝘕 𝘙𝘌𝘍𝘜𝘕𝘋𝘈𝘉𝘓𝘌 ⚠️";
                                 ...
                                 $gatesKeyboard = json_encode([
                                 'inline_keyboard' => [
                                     [                     ['text' => '• 𝙑𝙀𝙍𝙄𝙁𝙔 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 •', 'url' => 'https://t.me/Phrozehn'],   ], ]
  ]);
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https://t.me/Phrozehn"],
        ],
    ]
]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝙊𝙒𝙉𝙀𝙍", 'url' => "t.me/Gopinoob"], ['text' => "𝘾𝙃𝘼𝙉𝙉𝙀𝙇", 'url' => "https://t.me/PHROZEHN"]],
        [['text' => "𝙂𝙊 𝘽𝘼𝘾𝙆 ", 'callback_data' => 'back2']]
    ]
]);
...
if ($cdata2 == "back2") {
    ...
    // Change this to your video url
    $backVideoUrl = "https://th.bing.com/th/id/OIG2.BGH.0W1FHouu8QBJb7Dc?pid=ImgGn"; 
