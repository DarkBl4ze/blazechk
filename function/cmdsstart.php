...
$videoURLStart = "https://th.bing.com/th/id/OIG2.BGH.0W1FHouu8QBJb7Dc?pid=ImgGn";


if (preg_match('/^(\/start|\.start|!start)/', $text)) {
    if (in_array($userId, $freeusers)) {
        $caption = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 <code>@$username</code> 𝘁𝗼 BLACKDEAD Checker
        ...
        'inline_keyboard' => [
            [
                             ['text' => '𝙂𝘼𝙏𝙀𝙒𝘼𝙔𝙎', 'callback_data' => 'gates'],
                                 ...
                                 [
                                 ['text' => '@PHROZEHN', 'callback_data' => 'channel'],
                             ],
        ]
    ]);

    $caption = "Welcome To BLACKDEAD. Buy The Plan First.  /price 
...

{
 ...
 $caption=" Pricing BLACKDEAD Checker
━━━━━━━━━━━━━━━━━━
⑄ 𝙎𝙐𝘽𝙎𝘾𝙍𝙄𝙋𝙏𝙄𝙊𝙉 𝙈𝙀𝙉𝙐 ⑄
━━━━━━━━━━━━━━━━━━
× 1 𝘞𝘌𝘌𝘒  - 3$
